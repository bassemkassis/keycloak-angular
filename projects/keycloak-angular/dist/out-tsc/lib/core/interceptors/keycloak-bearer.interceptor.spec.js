...
describe('KeycloakBearerInterceptor', () => {
    ...
    it('should be created', inject([KeycloakBearerInterceptor], (service) => {
        expect(service).toBeTruthy();
    }));
    it('should add token to request and call to update the keycloak token', inject([KeycloakBearerInterceptor], (service) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not add token to request', inject([KeycloakBearerInterceptor], (service) => __awaiter(void 0, void 0, void 0, function* () {
        const request = new HttpRequest('GET', 'test', {
            headers: new HttpHeaders({
                'header-a': 'value'
            })
    ...
    it('should not call to update the keycloak token if the request has a header value that matches any value for any header in the exclusion list', inject([KeycloakBearerInterceptor], (service) => __awaiter(void 0, void 0, void 0, function* () {
        const request = new HttpRequest('GET', 'test', {
            headers: new HttpHeaders({
                'header-b': 'value2'
            })
...
//# sourceMappingURL=keycloak-bearer.interceptor.spec.js.map